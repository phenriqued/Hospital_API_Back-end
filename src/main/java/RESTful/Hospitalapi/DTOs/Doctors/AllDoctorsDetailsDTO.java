...
public record AllDoctorsDetailsDTO(InformationClientDTO information, Speciality speciality) {

    public AllDoctorsDetailsDTO(DoctorEntity entity){
        this(new InformationClientDTO(entity.getInformation()), entity.getSpeciality());
    }
